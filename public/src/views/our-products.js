  ...
  return (
    <div className="our-products-container">
      ...
      <div className="our-products-gallery1">
        <h1 className="our-products-text13">Our Products</h1>
        <span className="our-products-text14">
          <span>
            <span>
      ...
      <div className="our-products-stats">
        <div className="our-products-stat">
          <h1 className="our-products-text21">
            <span>50</span>
            <span>+</span>
          </h1>
          <span className="our-products-text24">Happy clients</span>
          <span className="our-products-text25">
            Lorem ipsum dolor sit amet, consectetur adipiscing.
          </span>
        </div>
        <div className="our-products-stat1">
          <h1 className="our-products-text26">
            <span>369</span>
          </h1>
          <span className="our-products-text28">Projects completed</span>
          <span className="our-products-text29">
            Lorem ipsum dolor sit amet, consectetur adipiscing.
          </span>
        </div>
        <div className="our-products-stat2">
          <h1 className="our-products-text30">
            <span>500</span>
            <span>+</span>
          </h1>
          <span className="our-products-text33">Hours</span>
          <span className="our-products-text34">
            Lorem ipsum dolor sit amet, consectetur adipiscing.
          </span>
        </div>
        <div className="our-products-stat3">
          <h1 className="our-products-text35">
            <span>24/7</span>
          </h1>
          <span className="our-products-text37">Support</span>
          <span className="our-products-text38">
            Lorem ipsum dolor sit amet, consectetur adipiscing.
          </span>
        </div>
      </div>
      ...
      <footer className="our-products-footer">
        <div className="our-products-container4">
          <div className="our-products-logo1">
            ...
            />
            <span className="our-products-text39">
              <br></br>
          ...
          <div className="our-products-links-container">
            <div className="our-products-container5">
              <div className="our-products-product-container">
                <span className="our-products-text46">Product</span>
                <span className="our-products-text47">Features</span>
                <span className="our-products-text48">Pricing</span>
                <span className="our-products-text49">Tutorials</span>
                <span>Releases</span>
              </div>
              <div className="our-products-company-container">
                <span className="our-products-text51">Company</span>
                <span className="our-products-text52">About</span>
                <span className="our-products-text53">Careers</span>
                <span className="our-products-text54">Contact</span>
                <span>Blog</span>
              </div>
            </div>
            <div className="our-products-location-1">
              ...
              <div className="our-products-phone">
                ...
                <span>
                  ...
                  <a href="tel:+251 903 502641">
                    <br className="our-products-text67"></br>
                  </a>
              ...
              <span className="our-products-text69">Follow Us</span>
        ...
        <span className="our-products-text70">
