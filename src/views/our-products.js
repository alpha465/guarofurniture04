  ...
  return (
    <div className="our-products-container">
      ...
      <div data-role="Header" className="our-products-navbar-container">
        <div className="our-products-navbar">
          ...
          <div className="our-products-links-container">
            ...
            <a href="#services" className="our-products-link01 Anchor">
              Products
            </a>
            <span className="our-products-link02 Anchor">About Us</span>
            <a href="#contact" className="our-products-link03 Anchor">
              contact Us
            </a>
          </div>
      ...
      <div className="our-products-gallery1">
        <h1 className="our-products-text15">Our portfolio</h1>
